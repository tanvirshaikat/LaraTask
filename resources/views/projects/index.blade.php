        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">Projects <a class="btn" href="{{ route('projects.create') }}"><i class="fa fa-plus"></i> Create Project</a></div>
                    </div>
                </div>
                            ...
                            @foreach( $projects as $project )
                                <li class="list-group-item">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <a class="btn btn-info text-white" href="{{ route('projects.edit', ['id' => $project->id]) }}"><i class="fa fa-pencil"></i> Edit</a>
                                        </div>
                                        <div class="col-auto">
