        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col">Tasks <a class="btn" href="<?php echo e(route('tasks.create')); ?>"><i class="fa fa-plus"></i> Create Task</a> </div>
                        <div class="col-auto" style="display: flex;">
                            <a class="btn" href="<?php echo e(route('projects.create')); ?>"><i class="fa fa-plus"></i> Create Project</a>
                            ...
                            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item" data-task-id="<?php echo e($task->id); ?>" data-project-id="<?php echo e($task->project ? $task->project->id : ''); ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-auto"><a class="btn btn-info text-white" href="<?php echo e(route('tasks.edit', ['id' => $task->id])); ?>"><i class="fa fa-pencil"></i> Edit</a></div>
                                        <div class="col-auto">
    ...
    <script>
        $("#sortable").sortable({
            stop: function( event, ui ) {
                ...
                $.ajax({
                    url: "<?php echo e(route('tasks.priorityOrder')); ?>",
                    method: 'POST',
                    dataType: 'json',
                    data: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH I:\xampp\htdocs\task-management\resources\views/tasks/index.blade.php ENDPATH**/ ?>